...
export default function GlobalErrorPage({ error, reset }: GlobalErrorPageProps) {
  ...
  return (
    <html lang="en">
      <body>
        <main className="relative isolate flex min-h-screen items-center justify-center overflow-hidden bg-bg-primary px-6 py-16 text-text-primary sm:px-8">
          ...
          <div className="relative z-10 mx-auto flex w-full max-w-3xl flex-col items-center text-center">
            <p className="type-accent-label text-text-muted">Application error</p>
            ...
            <p className="mt-6 max-w-xl text-balance text-lg leading-8 text-text-secondary sm:text-xl">
              The site hit a temporary issue. Try again and it should recover cleanly.
            </p>
