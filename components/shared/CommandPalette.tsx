  ...
  const items = useMemo<PaletteItem[]>(() => {
    const pageItems: PaletteItem[] = [
      ...
      },
      {
        ...
        href: "/projects",
        keywords: ["projects", "case studies", "portfolio", "work"],
        Icon: FolderKanban,
      },
      {
        id: "page-blog",
        ...
        href: "/blog",
        keywords: ["blog", "articles", "writing", "mdx"],
        Icon: Newspaper,
      },
      {
        id: "page-about",
      ...
      },
      {
        ...
        type: "link",
        label: "Services",
        description: "Ways to collaborate on product and backend engineering",
        href: "/services",
        keywords: ["hire", "services", "collaboration", "backend"],
        Icon: Sparkles,
      },
      {
      ...
      },
      {
        ...
        type: "link",
        label: "Newsletter",
        description: "Short engineering notes and project updates",
        href: "/newsletter",
        keywords: ["newsletter", "updates", "writing"],
        Icon: BookOpen,
      },
      {
        id: "page-external-writing",
        group: "Pages",
        type: "link",
        label: "External writing",
        description: "Published writing outside this site",
        href: "/blog/external",
        keywords: ["medium", "external", "articles"],
        Icon: FileText,
      },
      {
        id: "page-uses",
